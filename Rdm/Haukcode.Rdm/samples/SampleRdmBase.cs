...
public abstract class SampleRdmBase : IDisposable
{
    protected readonly ArtNetRdmClient client;
    private Task writerTask;

    public SampleRdmBase(IPAddress localIp, IPAddress localSubnetMask)
    {
        var channel = Channel.CreateUnbounded<ReceiveDataPacket>();

        this.client = new ArtNetRdmClient(
