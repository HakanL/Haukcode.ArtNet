...
{
    public ArtNetRdmClient(IPAddress localAddress, IPAddress localSubnetMask, Func<ReceiveDataPacket, Task>? channelWriter = null, Action? channelWriterComplete = null, int port = DefaultPort, UId? rdmId = null) : base(localAddress, localSubnetMask, channelWriter, channelWriterComplete, port, rdmId)
    {
    }
